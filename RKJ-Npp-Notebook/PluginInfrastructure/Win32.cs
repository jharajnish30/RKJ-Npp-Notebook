...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    public class Win32
    {
        ...
        /// <summary>
        /// RKJ (FindInFiles) - You should try to avoid calling this method in your plugin code. Rather use one of the gateways such as 
        /// <see cref="ScintillaGateway"/> or <see cref="NotepadPPGateway"/>.  
        /// If gateways are missing or incomplete, please help extend them and send your code to the project 
        /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
        /// </summary>
        [DllImport("user32")]
        public static extern IntPtr SendMessage(IntPtr hWnd, UInt32 Msg, [MarshalAs(UnmanagedType.LPWStr)] string wParam, [MarshalAs(UnmanagedType.LPWStr)] string lParam);
        ...
        ///// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
        ///// </summary>
        //public static IntPtr SendMessage(IntPtr hWnd, uint Msg, string wParam, string lParam)
        //{
        ...
        /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
        /// </summary>
        public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, string wParam, string lParam)
        {
            return SendMessage(hWnd, (UInt32)Msg, wParam, lParam);
        }

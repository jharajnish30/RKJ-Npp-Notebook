...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
	...
	public class NotepadPPGateway : INotepadPPGateway
	{
		...
		/// <summary>RKJ (FindInFiles) - Displays "Find in Files" Dialog with Directory and Filters value set. </summary>
		public void ShowFindInFilesDlg(string FindDirectory, string FindFilters)
		{
			//PluginBase.nppData._nppHandle, (uint)NppMsg.NPPM_LAUNCHFINDINFILESDLG or SciMsg.NPPM_LAUNCHFINDINFILESDLG
			Win32.SendMessage(PluginBase.nppData._nppHandle, NppMsg.NPPM_LAUNCHFINDINFILESDLG, FindDirectory, FindFilters);
		}
	}
